          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl border border-secureblue-100 shadow-sm">
              <div className="flex items-center mb-4">
                <div className="h-12 w-12 rounded-full bg-secureblue-100 mr-4"></div>
                <div>
                  <h4 className="font-semibold">Sarah Johnson</h4>
                  <p className="text-sm text-gray-600">Chief Information Security Officer, State of Washington</p>
                </div>
              </div>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-xl border border-secureblue-100 shadow-sm">
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">IT Director, Oregon Department of Administrative Services</p>
                </div>
              </div>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-xl border border-secureblue-100 shadow-sm">
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Cybersecurity Analyst, Florida Digital Service</p>
                </div>
              </div>
              <p className="text-gray-600">
